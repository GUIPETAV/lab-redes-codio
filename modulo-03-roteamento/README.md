...
- `ip addr` — mostra as interfaces de rede da sua máquina e seus IPs
- `ip route` — mostra a tabela de roteamento (o "mapa" de onde cada pacote vai)
- `traceroute` — mostra cada "salto" (roteador) no caminho até o destino
